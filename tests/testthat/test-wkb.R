...
test_that("s2polyline can be imported from wkb", {
  ...
  wkb_polyline <- list(as.raw(c(0x01, 0x02, 0x00, 0x00, 0x20, 0xe6, 0x10, 0x00,
...
test_that("s2polygon can be imported from wkb", {
  ...
  wkb_polygon <- list(as.raw(c(0x01, 0x03, 0x00, 0x00, 0x20, 0xe6, 0x10, 0x00,
                               0x00, 0x02, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,
